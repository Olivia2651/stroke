...
def main():
  ...
  work_type= st.selectbox('Input the type of work you do.\n2 \n if Private ,3 if Self-employed ,0 if Govt_job ,4 if children ,1 if Never_worked',(2,3,0,4,1))
  ...
  smoking_status=st.selectbox('Input your smoking status.\n \n 1 if formerly smoked ,2 if never smoked ,3 if smokes ,0 if Unknown' ,(1,2,3,0))
